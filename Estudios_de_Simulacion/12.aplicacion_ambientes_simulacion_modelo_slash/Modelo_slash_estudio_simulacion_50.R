...
#-----------------------------------------------------------------------------
#-----------simulación de las 1000 muestras para el ambiente  n = 50----------
#-----------------------------------------------------------------------------

#matriz_diseño_50_slash <- matriz_diseño(50) #genero la matriz diseño
#muestras <- muestra_slash_completa_50(m_dis =  matriz_diseño_50_slash, B_1 = B_1, 
#                                  M_1 = M_1, nu_1 = nu_1, N_muestras = 10000) 
#genero las muestras
#load("muestras_50_slash_completa.Rdata")
#length(muestras)
#aquí, genero las muestras con datos faltantes
#muestras_50_slash_faltantes <- muestra_faltantes_slash_50(muestras = muestras,
#  m_diseño = matriz_diseño_50_slash, B_1 = B_1, M_1 = M_1)#aquí genero
#length(muestras_50_slash_faltantes)
#set.seed(131247)
#muestras_extraer <- sample(1:length(muestras_50_slash_faltantes), 1000)
#muestras_50_slash_faltantes <- muestras_50_slash_faltantes[muestras_extraer]

#save(muestras, matriz_diseño_50_slash, file = "muestras_50_slash_completa.Rdata")
#save(muestras_50_slash_faltantes, matriz_diseño_50_slash, 
#     file = "muestras_50_slash_faltantes.Rdata")
load("muestras_50_slash_faltantes.Rdata")
#-----------------------------------------------------------------------------
#-------------Aplicción del modelo slash a las 1000 muestras------------------
#-----------------------------------------------------------------------------
#-----------------------------------------------------------------------------

#lista_estimaciones_50_slash <- list()
...
for (i in 13:length(muestras_50_slash_faltantes)){
  ...
  estim_50_slash <- medianas_modelo_slash(y_mp1, x_mp1, B_0, M_0, nu_0, 
                                            Nsim = 10000)#aquí aplico a cada 
    #muestra las 10000 replicas y le saco la mediana.
  lista_estimaciones_50_slash[[i]] <- estim_50_slash
  save(lista_estimaciones_50_slash, file = "estimaciones_modelo_slash_50.Rdata")
  }
