#modelamiento de cuantiles muestra de tamaño 100 t
setwd("ruta")
load("estimaciones_100_modelo_t.Rdata")
load("muestras_100_t_completa.Rdata")
X_dis <- matriz_diseño_100_t
library(stats)
...
cuantil_25_niña <- calculo_cuantiles_niñas_25(lista_estimaciones_100_t, matriz_diseño_100_t)
...
cuantil_50_niñas <- calculo_cuantiles_niñas_50(lista_estimaciones_100_t, matriz_diseño_100_t)
...
cuantil_75_niñas <- calculo_cuantiles_niñas_75(lista_estimaciones_100_t, 
                                               matriz_diseño_100_t)
...
cuantil_25_niños <- calculo_cuantiles_niños_25(lista_estimaciones_100_t, matriz_diseño_100_t)
...
cuantil_50_niños <- calculo_cuantiles_niños_50(lista_estimaciones_100_t, 
                                               matriz_diseño_100_t)
...
cuantil_75_niños <- calculo_cuantiles_niños_75(lista_estimaciones_100_t, 
                                               matriz_diseño_100_t)
