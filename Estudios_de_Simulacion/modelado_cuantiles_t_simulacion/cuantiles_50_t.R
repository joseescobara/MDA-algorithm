#modelamiento de cuantiles muestra de tamaño 50 t
setwd("ruta")
load("estimaciones_50_modelo_t.Rdata")
load("muestras_50_t_completa.Rdata")
X_dis <- matriz_diseño_50_t
library(stats)
...
cuantil_25_niña <- calculo_cuantiles_niñas_25(lista_estimaciones_50_t, matriz_diseño_50_t)
...
cuantil_50_niñas <- calculo_cuantiles_niñas_50(lista_estimaciones_50_t, matriz_diseño_50_t)
...
cuantil_75_niñas <- calculo_cuantiles_niñas_75(lista_estimaciones_50_t, 
                                               matriz_diseño_50_t)
...
cuantil_25_niños <- calculo_cuantiles_niños_25(lista_estimaciones_50_t, matriz_diseño_50_t)
...
cuantil_50_niños <- calculo_cuantiles_niños_50(lista_estimaciones_50_t, matriz_diseño_50_t)
...
cuantil_75_niños <- calculo_cuantiles_niños_75(lista_estimaciones_50_t, matriz_diseño_50_t)
